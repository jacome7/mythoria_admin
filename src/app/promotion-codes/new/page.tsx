...
export default function NewPromotionCodePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.status === 409) {
        setError('A promotion code with that code already exists.');
        return;
      }
      if (!res.ok) {
        ...
        <form onSubmit={handleSubmit} className="space-y-6 bg-base-100 p-6 rounded-lg shadow-sm">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="form-control">
              ...
              <input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                  update('creditAmount', parseInt(e.target.value) || 0)
                }
                required
              />
            </div>
            ...
            <div className="form-control">
              ...
              <input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                  update('maxGlobalRedemptions', e.target.value)
                }
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="form-control">
              ...
              <input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                  update('validUntil', e.target.value)
                }
              />
            </div>
          </div>
          <div className="pt-4 flex justify-end gap-3">
            <Link
              ...
              aria-label="Cancel creating promotion code"
            >
              Cancel
            </Link>
