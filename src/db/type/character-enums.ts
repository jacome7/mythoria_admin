...
export const CHARACTER_TYPES = [
  ...
  // Animal types
  "dog", "cat", "bird", "other_animal",
  // Fantasy types
  "dragon", "elf_fairy_mythical", "robot_cyborg", "alien_extraterrestrial", "other_creature",
  // Other
  "other"
] as const;
...
export const POSITIVE_TRAITS: CharacterTrait[] = [
  "adaptable", "brave", "compassionate", "courageous", "curious", "decisive", 
  "empathetic", "generous", "honest", "imaginative", "loyal", 
  "optimistic", "patient", "practical", "pragmatic", "resourceful", "self-disciplined", 
  "sincere", "witty", "kind", "conscientious", "energetic"
];

export const NEGATIVE_TRAITS: CharacterTrait[] = [
  "arrogant", "callous", "cowardly", "cynical", "deceitful", 
  "impulsive", "jealous", "lazy", "manipulative", "moody", 
  "reckless", "selfish", "vengeful"
];

export const NEUTRAL_TRAITS: CharacterTrait[] = [
  "aloof", "blunt", "cautious", "methodical"
];
...
export const NON_HUMAN_CHARACTER_TYPES = ["dog", "cat", "bird", "other_animal", "dragon", "elf_fairy_mythical", "robot_cyborg", "alien_extraterrestrial", "other_creature", "other"];

// Human age options
export const HUMAN_AGES: CharacterAge[] = [
  "infant", "toddler", "preschool", "school_age", 
  "teenage", "emerging_adult", "seasoned_adult", "midlife_mentor", "elder"
];
...
export function getCharacterTraitOptions(searchTerm: string = '', t?: (key: string) => string): {
